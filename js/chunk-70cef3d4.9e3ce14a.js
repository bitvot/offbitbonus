                ...
                class ii {
                    ...
                    render() {
                        ...
                        return this.options.custom && (n = [...n, "custom"]), n.forEach(e => {
                            ...
                            this.options.icons && this.options.icons.categories && this.options.icons.categories[e] ? i.appendChild(Uo(this.options.icons.categories[e])) : i.innerHTML = oi[e], i.tabIndex = -1, i.title = this.i18n.categories[e], o.appendChild(i), this.buttons.push(i), i.addEventListener("click", () => {
                ...
                class ti {
                    constructor(e, o, i, n) {
                        ...
                        this.events = e, this.i18n = o, this.options = i, this.emojiCategories = n, this.currentCategory = 0, this.headers = [], this.focusedIndex = 0, this.handleKeyDown = e => {
                            ...
                            i.innerHTML = this.i18n.categories[e] || ei.categories[e], this.emojis.appendChild(i), this.headers.push(i), this.emojis.appendChild(new Jo(o, !0, this.events, this.options, "recents" !== e).render())
                ...
                class ri {
                    constructor(e = {}) {
                        this.events = new k, this.publicEvents = new k, this.pickerVisible = !1, this.options = Object.assign(Object.assign({}, ai), e), this.options.rootElement || (this.options.rootElement = document.body), this.i18n = Object.assign(Object.assign({}, ei), e.i18n), this.onDocumentClick = this.onDocumentClick.bind(this), this.onDocumentKeydown = this.onDocumentKeydown.bind(this), this.theme = this.options.theme || "light", this.emojiCategories = function(e) {
                            ...
                            return e.emoji.forEach(i => {
                                let n = o[e.categories[i.category || 0]];
                                n || (n = o[e.categories[i.category || 0]] = []), n.push(i)
                            }), o
                    ...
                    hidePicker() {
                        this.hideInProgress = !0, this.focusTrap.deactivate(), this.pickerVisible = !1, this.overlay && (document.body.removeChild(this.overlay), this.overlay = void 0), this.emojiArea.emojis.removeEventListener("scroll", this.emojiArea.highlightCategory), this.pickerEl.classList.add("hiding"), setTimeout(() => {
                            this.wrapper.style.display = "none", this.pickerEl.classList.remove("hiding"), this.pickerContent.firstChild !== this.emojiArea.container && (Me(this.pickerContent), this.pickerContent.appendChild(this.emojiArea.container)), this.search && this.search.clear(), this.events.emit("hideVariantPopup"), this.hideInProgress = !1, this.popper && this.popper.destroy(), this.publicEvents.emit("hidden")
